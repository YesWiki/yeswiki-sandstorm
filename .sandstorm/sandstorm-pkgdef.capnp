...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "rpsm27tq6zvau16dyhh13cun7nkn8qz8cced98p8e2wm27rkpf7h",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "YesWiki"),

    appVersion = 1,  # Increment this for every release.

    appMarketingVersion = (defaultText = "Cercopitheque 2016.01.20"),
    # Human-readable representation of appVersion. Should match the way you
    # identify versions of your app in documentation and marketing.

    actions = [
      # Define your "new document" handlers here.
      ( title = (defaultText = "New YesWiki site"),
        command = .myCommand
    ...
    metadata = (
      ...
      website = "http://yeswiki.net/cercopitheque",
      # This should be the app's main website url.

      codeUrl = "https://github.com/YesWiki/yeswiki",
      ...
      categories = [social,webPublishing],
      ...
      author = (
        ...
        #
        #     echo -n "I am the author of the Sandstorm.io app with the following ID: rpsm27tq6zvau16dyhh13cun7nkn8qz8cced98p8e2wm27rkpf7h" | gpg --sign > pgp-signature
        #
      ...
      shortDescription = (defaultText = "all-in-one wiki"),
